...
// class that create users to use application
public class User implements Searchable {
    ...
    private String salt;         // Salt of password
    private String bio;
    ...
    // salt is auto-generated, password is hashed.
    public User(String username, String displayName, String email,
    ...
    //club users override this.
    public boolean isClub() {
        return false;
    }

    
    // Profile badge clubUser overrides  
...
public boolean matchesSearch(String query) {
    ...
    // If interests match return true
